...
```{r all-combine, fig.cap= "a). Trajectory Plots for each Simulated Data Set b). Clusterings of Observed Data on Final Day of Data Set", message=FALSE, warning = FALSE, fig.height = 5, fig.width = 9, fig.align = 'center'}
