...
int_1x = all_lat(w1, f_sim1,polyg1,n1)


#Gives Location for Y
int_1y = all_long(w1,f_sim1,polyg1,n1)
...
#Gives Location for X
int_2x = all_lat(w2, f_sim2,polyg2,n2)


#Gives Location for Y
int_2y = all_long(w2,f_sim2,polyg2,n2)
...
#Gives Location for X
int_3x = all_lat(w3, f_sim3,polyg3,n3)

#Gives Location for Y
int_3y = all_long(w3,f_sim3,polyg3,n3)
...
result_data <- data.frame(X1 = c((error_x1), (error_x2), (error_x3)), Y1 = c((error_y1), (error_y2), (error_y3)), X2 = c(sqrt(error_x_lin1), sqrt(error_x_lin2), sqrt(error_x_lin3)), Y2 = c(sqrt(error_y_lin1), sqrt(error_y_lin2), sqrt(error_y_lin3)), X3 = c(sqrt(noint_x_sim1), sqrt(noint_x_sim2), sqrt(noint_x_sim3)), Y3 = c(sqrt(noint_y_sim1), sqrt(noint_y_sim2), sqrt(noint_y_sim3)), X4 = c(x_error1, x_error2, x_error3), Y4 = c(y_error1, y_error2, y_error3))

kableExtra::kable(result_data, booktabs = TRUE, caption = "RMSE for Interpolation Methods", col.names = c("$X_{int}$", "$Y_{int}$", "$X_{lin}$", "$Y_{lin}$", "$X_{no int}$", "$Y_{no int}$", "$X_{bi}$", "$Y_{bi}$"), escape = FALSE) %>% pack_rows(
...
result_cluster1_ice <- data.frame(Cluster = c(1,2,3,4,5,6), X1 = c(c_w1_x[,2]), Y1 = c(c_w1_y[,2]), X2 <- c(lin_w1_x[,2]), Y2 <- c(lin_w1_y[,2]), X3 = c(c_w1_x_noi[,2]), Y3 = c(c_w1_y_noi[,2]), X4 <- c(bi_c_x1[,2]), Y4 <- c(bi_c_y1[,2]))
...
result_cluster2_ice <- data.frame(Cluster = c(1,2,3,4,5), X1 = c(c_w2_x[,2]), Y1 = c(c_w2_y[,2]), X2 <- c(lin_w2_x[,2]), Y2 <- c(lin_w2_y[,2]), X3 = c(c_w2_x_noi[,2]), Y3 = c(c_w2_y_noi[,2]), X4 <- c(bi_c_x2[,2]), Y4 <- c(bi_c_y2[,2]))
#
...
result_cluster3_ice <- data.frame(Cluster = c(1,2,3,4,5,6), X1 = c(c_w3_x[,2]), Y1 = c(c_w3_y[,2]), X2 <- c(lin_w3_x[,2]), Y2 <- c(lin_w3_y[,2]), X3 = c(c_w3_x_noi[,2]), Y3 = c(c_w3_y_noi[,2]), X4 <- c(bi_c_x3[,2]), Y4 <- c(bi_c_y3[,2]))
#
...
cp_data <- data.frame(met = c(rep(c("Univariate", "Bivariate"), times = 3)), cov_probx = c(w1_cp_x2,cp_w1_bix, w2_cp_x2, cp_w2_bix, w3_cp_x2, cp_w3_bix), sdx = c(sd_mean_w1x, sd_w1_bix, sd_mean_w2x, sd_w2_bix, sd_mean_w3x, sd_w3_bix), cov_proby = c(w1_cp_y2, cp_w1_biy, w2_cp_y2, cp_w2_biy, w3_cp_y2, cp_w3_biy), sdx = c(sd_mean_w1y, sd_w1_biy, sd_mean_w2y, sd_w2_biy, sd_mean_w3y, sd_w3_biy))
