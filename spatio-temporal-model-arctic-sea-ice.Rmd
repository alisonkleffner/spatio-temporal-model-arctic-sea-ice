...
```{r int-best-plots, message=FALSE, warning = FALSE, cache=TRUE, fig.cap = "Trajectories for a) Week 2 Cluster 1, where our proposed univariate method peforms best and b) Week 2 Cluster 5, where linear interpolation performs best."}
...
result_data2 <- data.frame(X2 = c(round(sqrt(error_x_lin_actual_w1),2), round(sqrt(error_x_lin_actual_w2),2), round(sqrt(error_x_lin_actual_w3),2)), Y2 = c(round(sqrt(error_y_lin_actual_w1),2), round(sqrt(error_y_lin_actual_w2),2), round(sqrt(error_y_lin_actual_w3),2)), X1 = c(round(sqrt(e_w1_xn),2), round(sqrt(e_w2_xn),2), round(sqrt(e_w3_xn),2)), Y1 = c(round(sqrt(e_w1_yn),2), round(sqrt(e_w2_yn),2), round(sqrt(e_w3_yn),2)), X3 = c(round(sqrt(w1x),2), round(sqrt(w2x),2), round(sqrt(w3x),2)), Y3 = c(round(sqrt(w1y),2), round(sqrt(w2y),2), round(sqrt(w3y),2)), X4 = c(round(x_bi_error1,2), round(x_bi_error2,2), round(x_bi_error3,2)), Y4 = c(round(y_bi_error1,2), round(y_bi_error2,2), round(y_bi_error3,2)))
...
result_cluster1_ice <- data.frame(Cluster = c(1,2,3,4,5,6), X2 <- c(round(lin_w1_x[,2],2)), Y2 <- c(round(lin_w1_y[,2],2)), X1 = c(round(c_w1_xn[,2],2)), Y1 = c(round(c_w1_yn[,2],2)), X3 = c(round(c_w1_x_noi[,2],2)), Y3 = c(round(c_w1_y_noi[,2],2)), X4 <- c(round(bi_c_x1[,2],2)), Y4 <- c(round(bi_c_y1[,2],2)))

#
kableExtra::kable(result_cluster1_ice, booktabs = TRUE, caption = "RMSE by Cluster for Week 1 for Interpolation Methods", col.names = c("Cluster", "$X$", "$Y$", "$X$", "$Y$", "$X$", "$Y$", "$X$", "$Y$"), escape = FALSE) %>%
  add_header_above(c(" ", "Linear" = 2, "Univariate Intersection" = 2, "Overall Univariate" = 2, "Bivariate" = 2))
...
result_cluster2_ice <- data.frame(Cluster = c(1,2,3,4,5), X2 <- c(round(lin_w2_x[,2],2)), Y2 <- c(round(lin_w2_y[,2],2)), X1 = c(round(c_w2_xn[,2],2)), Y1 = c(round(c_w2_yn[,2],2)), X3 = c(round(c_w2_x_noi[,2],2)), Y3 = c(round(c_w2_y_noi[,2],2)), X4 <- c(round(bi_c_x2[,2],2)), Y4 <- c(round(bi_c_y2[,2],2)))
#
kableExtra::kable(result_cluster2_ice, booktabs = TRUE, caption = "RMSE by Cluster for Week 2 for Interpolation Methods", col.names = c("Cluster", "$X$", "$Y$", "$X$", "$Y$", "$X$", "$Y$", "$X$", "$Y$"), escape = FALSE) %>%
  add_header_above(c(" ", "Linear" = 2, "Univariate Intersection" = 2, "Overall Univariate" = 2, "Bivariate" = 2))
...
result_cluster3_ice <- data.frame(Cluster = c(1,2,3,4,5,6), X2 <- c(round(lin_w3_x[,2],2)), Y2 <- c(round(lin_w3_y[,2],2)), X1 = c(round(c_w3_xn[,2],2)), Y1 = c(round(c_w3_yn[,2],2)), X3 = c(round(c_w3_x_noi[,2],2)), Y3 = c(round(c_w3_y_noi[,2],2)), X4 <- c(round(bi_c_x3[,2],2)), Y4 <- c(round(bi_c_y3[,2],2)))
#
kableExtra::kable(result_cluster3_ice, booktabs = TRUE, caption = "RMSE by Cluster for Week 3 for Interpolation Methods", col.names = c("Cluster", "$X$", "$Y$", "$X$", "$Y$", "$X$", "$Y$", "$X$", "$Y$"), escape = FALSE) %>%
  add_header_above(c(" ", "Linear" = 2, "Univariate Intersection" = 2, "Overall Univariate" = 2, "Bivariate" = 2))
...
cp_data <- data.frame(met = c(rep(c("Univariate", "Bivariate"), times = 3)), cov_probx = c(round(w1_cp_x2n,3),round(cp_w1_bix,3), round(w2_cp_x2n,3), round(cp_w2_bix,3), round(w3_cp_x2n,3), round(cp_w3_bix,3)), sdx = c(round(sd_mean_w1xn,3), round(sd_w1_bix,3), round(sd_mean_w2xn,3), round(sd_w2_bix,3), round(sd_mean_w3xn,3), round(sd_w3_bix,3)), cov_proby = c(round(w1_cp_y2n,3), round(cp_w1_biy,3), round(w2_cp_y2n,3), round(cp_w2_biy,3), round(w3_cp_y2n,3), round(cp_w3_biy,3)), sdx = c(round(sd_mean_w1yn,3), round(sd_w1_biy,3), round(sd_mean_w2yn,3), round(sd_w2_biy,3), round(sd_mean_w3yn,3), round(sd_w3_biy,3)))

kableExtra::kable(cp_data, booktabs = TRUE, col.names = c("Method", "Proportion of X", "$\\bar{SD_X}$", "Proportion of Y", "$\\bar{SD_Y}$"), caption = "Proportion of Prediction interval containing observed and Average Standard Deviation for Ice Data", escape = FALSE) %>% pack_rows(
