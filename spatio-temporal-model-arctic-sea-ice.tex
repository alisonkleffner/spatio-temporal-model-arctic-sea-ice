...
Cluster & $\sigma^{2}_{x}$ & $\phi_{x,s}$ & $\tau_{x}$ & $c(0)$ & $\mu_x$ & $\sigma^{2}_{y}$ & $\phi_{y,s}$ & $\tau_{y}$ & $c(0)$ & $\mu_y$\\
\midrule
\addlinespace[0.3em]
...
\toprule
\multicolumn{2}{c}{Linear} & \multicolumn{2}{c}{Univariate Intersection} & \multicolumn{2}{c}{Overall Univariate} & \multicolumn{2}{c}{Bivariate} \\
...
\hspace{1em}1.04 & 1.23 & 1.50 & 1.51 & 1.43 & 1.29 & 1.54 & 1.67\\
\addlinespace[0.3em]
\multicolumn{8}{l}{\textbf{Simulation 2}}\\
\hspace{1em}1.45 & 1.54 & 1.54 & 1.55 & 1.47 & 1.49 & 1.63 & 1.58\\
\addlinespace[0.3em]
\multicolumn{8}{l}{\textbf{Simulation 3}}\\
\hspace{1em}0.95 & 0.92 & 1.41 & 1.40 & 1.46 & 1.51 & 1.43 & 1.51\\
\bottomrule
\end{tabular}
\end{table}
...
\toprule
\multicolumn{1}{c}{ } & \multicolumn{2}{c}{Linear} & \multicolumn{2}{c}{Univariate Intersection} & \multicolumn{2}{c}{Overall Unviariate} & \multicolumn{2}{c}{Bivariate} \\
\cmidrule(l{3pt}r{3pt}){2-3} \cmidrule(l{3pt}r{3pt}){4-5} \cmidrule(l{3pt}r{3pt}){6-7} \cmidrule(l{3pt}r{3pt}){8-9}
Cluster & $X$ & $Y$ & $X$ & $Y$ & $X$ & $Y$ & $X$ & $Y$\\
\midrule
\addlinespace[0.3em]
\multicolumn{9}{l}{\textbf{Simulation 1}}\\
\hspace{1em}1 & 0.82 & 1.16 & 1.41 & 1.58 & 1.54 & 1.28 & 1.41 & 1.77\\
\hspace{1em}2 & 1.19 & 1.27 & 1.57 & 1.47 & 1.35 & 1.29 & 1.63 & 1.59\\
\addlinespace[0.3em]
\multicolumn{9}{l}{\textbf{Simulation 2}}\\
\hspace{1em}1 & 1.32 & 1.33 & 1.70 & 1.64 & 1.66 & 1.60 & 1.80 & 1.72\\
\hspace{1em}2 & 1.50 & 1.61 & 1.50 & 1.52 & 1.40 & 1.45 & 1.57 & 1.54\\
\addlinespace[0.3em]
\multicolumn{9}{l}{\textbf{Simulation 3}}\\
\hspace{1em}1 & 1.16 & 1.10 & 1.46 & 1.48 & 1.43 & 1.44 & 1.49 & 1.51\\
\hspace{1em}2 & 0.65 & 0.67 & 1.35 & 1.31 & 1.49 & 1.58 & 1.36 & 1.51\\
\bottomrule
\end{tabular}
\end{table}
...
\caption{\label{tab:cp-table-sim}Coverage of the proposed Univariate and Bivariate Models along with their Average Standard Deviation for the Simulated Data}
\centering
\begin{tabular}[t]{lrrrr}
\toprule
Method & $Coverage_{X}$ & $\bar{SD_{X}}$ & $Coverage_{Y}$ & $\bar{SD_{Y}}$\\
\midrule
\addlinespace[0.3em]
\multicolumn{5}{l}{\textbf{Simulation 1}}\\
\hspace{1em}Univariate & 0.257 & 0.383 & 0.271 & 0.351\\
\hspace{1em}Bivariate & 0.014 & 0.016 & 0.014 & 0.035\\
\addlinespace[0.3em]
\multicolumn{5}{l}{\textbf{Simulation 2}}\\
\hspace{1em}Univariate & 0.214 & 0.349 & 0.196 & 0.378\\
\hspace{1em}Bivariate & 0.000 & 0.001 & 0.000 & 0.001\\
\addlinespace[0.3em]
\multicolumn{5}{l}{\textbf{Simulation 3}}\\
\hspace{1em}Univariate & 0.243 & 0.319 & 0.311 & 0.337\\
\hspace{1em}Bivariate & 0.014 & 0.001 & 0.000 & 0.001\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{tabular}[t]{rrrrrrrr}
\toprule
\multicolumn{2}{c}{Linear} & \multicolumn{2}{c}{Univariate Intersection} & \multicolumn{2}{c}{Univariate Overall} & \multicolumn{2}{c}{Bivariate} \\
\cmidrule(l{3pt}r{3pt}){1-2} \cmidrule(l{3pt}r{3pt}){3-4} \cmidrule(l{3pt}r{3pt}){5-6} \cmidrule(l{3pt}r{3pt}){7-8}
$X$ & $Y$ & $X$ & $Y$ & $X$ & $Y$ & $X$ & $Y$\\
\midrule
\addlinespace[0.3em]
\multicolumn{8}{l}{\textbf{Week 1}}\\
\hspace{1em}1.53 & 4.18 & 3.25 & 3.21 & 3.09 & 2.88 & 3.17 & 7.72\\
\addlinespace[0.3em]
\multicolumn{8}{l}{\textbf{Week 2}}\\
\hspace{1em}2.00 & 1.40 & 3.14 & 3.06 & 3.20 & 3.15 & 3.19 & 3.11\\
\addlinespace[0.3em]
\multicolumn{8}{l}{\textbf{Week 3}}\\
\hspace{1em}1.03 & 1.21 & 3.17 & 3.09 & 3.19 & 3.15 & 3.13 & 3.04\\
\bottomrule
\end{tabular}
\end{table}
...
Cluster & $X$ & $Y$ & $X$ & $Y$ & $X$ & $Y$ & $X$ & $Y$\\
\midrule
1 & 3.20 & 13.04 & 3.07 & 4.10 & 2.52 & 3.61 & 3.16 & 17.68\\
2 & 0.19 & 0.36 & 4.36 & 4.30 & 4.26 & 3.98 & 4.58 & 4.63\\
3 & 1.31 & 3.07 & 3.08 & 3.10 & 2.17 & 2.72 & 2.85 & 9.88\\
4 & 1.40 & 2.44 & 3.10 & 2.85 & 2.46 & 2.34 & 2.97 & 2.79\\
5 & 0.77 & 3.17 & 3.91 & 3.67 & 3.89 & 2.55 & 3.99 & 8.78\\
\addlinespace
6 & 1.89 & 5.64 & 3.10 & 3.06 & 2.63 & 3.35 & 3.23 & 4.69\\
\bottomrule
\end{tabular}
\end{table}
...
Cluster & $X$ & $Y$ & $X$ & $Y$ & $X$ & $Y$ & $X$ & $Y$\\
\midrule
1 & 3.24 & 3.32 & 3.00 & 2.93 & 2.62 & 3.04 & 3.05 & 4.60\\
2 & 2.55 & 1.03 & 2.94 & 2.89 & 2.89 & 2.94 & 3.04 & 2.88\\
3 & 1.58 & 1.99 & 2.94 & 2.90 & 2.95 & 3.03 & 2.95 & 2.91\\
4 & 1.40 & 0.52 & 3.26 & 3.13 & 3.45 & 3.19 & 3.37 & 3.17\\
5 & 0.31 & 0.37 & 4.23 & 4.16 & 4.41 & 4.20 & 4.32 & 4.28\\
\bottomrule
\end{tabular}
\end{table}
...
Cluster & $X$ & $Y$ & $X$ & $Y$ & $X$ & $Y$ & $X$ & $Y$\\
\midrule
1 & 2.04 & 2.67 & 2.85 & 2.85 & 2.70 & 3.04 & 2.94 & 2.84\\
2 & 2.15 & 2.06 & 2.81 & 2.95 & 2.65 & 2.85 & 2.68 & 2.97\\
3 & 0.19 & 0.44 & 3.65 & 3.59 & 3.75 & 3.60 & 3.70 & 3.61\\
4 & 1.53 & 0.72 & 2.67 & 2.78 & 2.87 & 2.92 & 2.61 & 2.87\\
5 & 0.21 & 0.48 & 3.16 & 3.04 & 3.08 & 3.09 & 3.11 & 2.99\\
\addlinespace
6 & 0.28 & 0.55 & 3.21 & 3.01 & 3.23 & 3.01 & 3.25 & 3.03\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{tabular}[t]{lrrrr}
\toprule
Method & Proportion of X & $\bar{SD_X}$ & Proportion of Y & $\bar{SD_Y}$\\
\midrule
\addlinespace[0.3em]
\multicolumn{5}{l}{\textbf{Week 1}}\\
\hspace{1em}Univariate & 0.256 & 0.788 & 0.293 & 0.834\\
\hspace{1em}Bivariate & 0.005 & 0.016 & 0.018 & 0.087\\
\addlinespace[0.3em]
\multicolumn{5}{l}{\textbf{Week 2}}\\
\hspace{1em}Univariate & 0.263 & 0.751 & 0.298 & 0.810\\
\hspace{1em}Bivariate & 0.009 & 0.026 & 0.015 & 0.026\\
\addlinespace[0.3em]
\multicolumn{5}{l}{\textbf{Week 3}}\\
\hspace{1em}Univariate & 0.246 & 0.760 & 0.263 & 0.796\\
\hspace{1em}Bivariate & 0.004 & 0.010 & 0.007 & 0.019\\
\bottomrule
\end{tabular}
\end{table}
